...
import proposalclasses.Effect;
import proposalclasses.EffectSet;
 ...
 * @author dylanleong
 */
public class FXMLProposalController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        applicant_map = new HashMap<>();
        recipient_map = new HashMap<>();
        both_map = new HashMap<>();
    ...
    public void init(String title, String description, ArrayList<Decision> decision_checker, int id, TreeSet<Decision> decisions) {
        txtProposalName.setText(title);
    ...
    private void handleBtnCancel(ActionEvent event) {
        ...
        alert.setHeaderText("Are you sure you want to cancel this custom decision?");
        alert.setContentText("Cancelling this custom decision will be treated as rejecting the student's proposal.");
        alert.initModality(Modality.APPLICATION_MODAL);
    ...
    private ArrayList<String> effectParser(Collection<EffectSet> role_values) {
        ...
        for (EffectSet each_set : role_values) {
            ...
            for (Effect each_effect : each_set.effect_list) {
                ...
                effect_str += " " + category + " " + each_effect.getValue() + " " + each_effect.getDelay() + " " + "false";
            }
